...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
	...
	<br/> <br/><span><?php echo $text_stock; ?></span> <?php // echo $stock; ?>  <span id="product_qty"><?php  echo $product_quantity; ?></span><br/>
    <span><?php if($delivery_time){  echo $delivery_time; }; ?></span><br/>
