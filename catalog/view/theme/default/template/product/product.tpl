	...
	<div id="qunda">
		<div>
			<div class="table">
				...
				<div>
					<h3>Mieszko Malawski</h3> <img src="catalog/view/theme/default/image/stars-4.png" alt="<?php echo $reviews; ?>" /> &nbsp; <span class="verify"><i class="fa fa-check-square-o"></i> verify</span>
			...
			<div class="table">
				<div class="img"><span><i class="fa fa-bicycle"></i></span></div>
				<div>
					<h3>Mieszko Malawski</h3> <span class="verify"><i class="fa fa-check-square-o"></i> verify</span>
